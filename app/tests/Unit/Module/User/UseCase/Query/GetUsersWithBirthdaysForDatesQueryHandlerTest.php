...
beforeEach(function (): void {
    ...
    $this->handler = new GetUsersWithBirthdaysForDatesQueryHandler(userRepository: $this->userRepository);
});

it('finds users with birthdays between given dates', function () {
...
it('returns empty array when no users have birthdays in date range', function () {
    $startDate = new DateTimeImmutable('2025-01-01');
    $endDate = new DateTimeImmutable('2025-01-31');
