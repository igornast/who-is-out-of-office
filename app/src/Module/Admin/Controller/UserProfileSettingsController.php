...
class UserProfileSettingsController extends AbstractController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        return $this->render('@AppAdmin/user/profile_edit.html.twig', [
            ...
            'slack_status_sync_enabled' => $user->slackIntegration->slackStatusSyncEnabled ?? true,
            'slack_status_sync_feature_enabled' => $this->appSettingsFacade->isSlackStatusSyncEnabled(),
